<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <br>
        Berikut ini adalah daftar kelas yang kamu ikuti. Mengalami kesusahan untuk bahan ajaran? Pelajari tips menulis
        di SIPS.
    </div>
    <div class="card-body">

        @forelse (DB::table('classroom_user')->where('user_id', Auth::user()->id)->where('deleted_at', null)->get() as
        $class)
            ...
            <div class="card-body">
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar" role="progressbar"
                        style="width: {{ $progress / $teachables * 100 }}%" aria-valuenow="10" aria-valuemin="0"
                        aria-valuemax="100">{{ number_format($progress / $teachables * 100) }} %
                    </div>
                </div>
            </div>
        </div>
