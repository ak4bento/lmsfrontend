...
<style>
    .bg-overlay {
        background: linear-gradient(rgba(0, 0, 0, 0.137), rgba(0, 0, 0, 0.226)),
        url("{{asset('files')}}/{{$media->file_name}}");
        margin-bottom: 10px;
        border-radius: 10px;
...
<style>
    .bg-overlay:hover {
        cursor: pointer;
        background: linear-gradient(rgba(0, 0, 0, 0.377), rgba(0, 0, 0, 0.5)),
        url("{{asset('files')}}/{{$media->file_name}}");
        background-repeat: no-repeat;
        background-size: cover;
        background-position: right;
...
@endpush
<div class="container">
    <div @hasanyrole('owner') @if ($classroomUsersCount> 0)
                    ...
                    <div class="fixme">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                @hasanyrole('student')
                                @if ($classroomUsersCount < 1) <a class="btn btn-primary btn-block join-class"
                            ...
                            <div class="col-10 col-lg-10 col-md-10 col-sm-10">
                                <div class="row">
                                    ...
                                    <a data-toggle="tooltip" data-placement="top" title="Lihat Kuis"
                                        ...
                                        @if (App\Models\Progress::where('progress_type',
                                        'quizzes')->where('progress_id', $teachable->teachable_id)->where('class_id',
                                        $classrooms->id)->where('user_id', Auth::user()->id)->count() > 0)
                                    ...
                                    <a data-toggle="tooltip" data-placement="top" title="Lihat Materi"
                                        ...
                                        @if (App\Models\Progress::where('progress_type',
                                        'resources')->where('progress_id', $teachable->teachable_id)->where('class_id',
                                        $classrooms->id)->where('user_id', Auth::user()->id)->count() > 0)
                                        <i class="fas fa-check-circle text-success"></i>
                                        @endif
                                    ...
                                    <a data-toggle="tooltip" data-placement="top" title="Lihat Tugas"
                                        ...
                                        @if (App\Models\Progress::where('progress_type',
                                        'assignments')->where('progress_id',
                                        $teachable->teachable_id)->where('class_id', $classrooms->id)->where('user_id',
                            ...
                            <div class="col-2 col-lg-2 col-md-2 col-sm-2">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <a data-teachable_id="{{$teachable->id}}"
                                ...
                                <i style="font-size: 20px" data-slug="{{$classrooms->slug}}"
