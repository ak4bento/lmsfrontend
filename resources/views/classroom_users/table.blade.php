        ...
        @foreach($classroomUsers as $classroomUser)
            ...
            <td>{{ $classroomUser->last_accesed_at }}</td>
                <td width="120">
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('classroomUsers.show', [$classroomUser->id]) }}" class='btn btn-default btn-xs'>
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('classroomUsers.edit', [$classroomUser->id]) }}" class='btn btn-default btn-xs'>
